...
public class Declaration {
    ...
    public static Block blockRestZone = new Block(8, '+', "floor.png", false, false, true);
    public static Block blockEnemyZone = new Block(9, '-', "floor.png", false, true, false);

    public static Block blockSeller = new Block(10, '$', "floor.png", false, false, true) {
    ...
    public static Block blockMaster = new Block(11, 'M', "floor.png", false, false, true) {
