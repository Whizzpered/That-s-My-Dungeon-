...
public class Frame {
    ...
    public void render(double x, double y, double width, double height) {
        ...
        }
        {
            glTexCoord2d(0, 0);
            glVertex2d(x, y + 16);
            glTexCoord2d((height - 31) / 16, 0);
            glVertex2d(x, y + height - 15);
            glTexCoord2d((height - 31) / 16, 1);
            glVertex2d(x + 16, y + height - 15);
            glTexCoord2d(0, 1);
            glVertex2d(x + 16, y + 16);
        }
        {
        ...
        }
        {
            ...
            glVertex2d(x + width, y + 16);
            glTexCoord2d((height - 31) / 16, 0);
            glVertex2d(x + width, y + height - 15);
            glTexCoord2d((height - 31) / 16, 1);
            glVertex2d(x + width - 16, y + height - 15);
            glTexCoord2d(0, 1);
            glVertex2d(x + width - 16, y + 16);
        }
        glEnd();
        ...
        glBegin(GL_QUADS);
        {
            ...
            glTexCoord2d((width - 31) / 16, 0);
            glVertex2d(x + width - 15, y + 16);
            glTexCoord2d((width - 31) / 16, (height - 31) / 16);
            glVertex2d(x + width - 15, y + height - 15);
            glTexCoord2d(0, (height - 31) / 16);
            glVertex2d(x + 16, y + height - 15);
        }
        glEnd();
    }
